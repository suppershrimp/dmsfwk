...
class DistributedMessageParcel {
public:
    virtual ~DistributedMessageParcel() = default;
public:
...
public:
    static inline std::shared_ptr<DistributedMessageParcel> messageParcel = nullptr;
};

class MessageParcelMock : public DistributedMessageParcel {
public:
