 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, GetSetDeviceInfo_001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, MarshallingUnmarshalling_001, TestSize.Level1)
{
    ...
    Parcel parcel;
    int32_t result1 = continuationResult1.Marshalling(parcel);
    DTEST_LOG << "result1:" << result1 << endl;

    ContinuationResult *continuationResult2 = continuationResult1.Unmarshalling(parcel);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, ReadFromParcel_001, TestSize.Level1)
{
    ...
    Parcel parcel;
    int32_t result1 = continuationResult.Marshalling(parcel);
    int32_t result2 = continuationResult.ReadFromParcel(parcel);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, Write_Read_ContinuationResultsFromParcel_001, TestSize.Level1)
{
    ...
    Parcel parcel;
    int32_t result1 = ContinuationResult::WriteContinuationResultsToParcel(parcel, continuationResults1);
    std::vector<ContinuationResult> continuationResults2;
    int32_t result2 = ContinuationResult::ReadContinuationResultsFromParcel(parcel, continuationResults2);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, Str16VecToStr8Vec_001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, SetFunction_001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, ReadFromParcel_002, TestSize.Level1)
{
    ...
    Parcel parcel;
    int32_t result1 = continuationExtraParams.Marshalling(parcel);
    int32_t result2 = continuationExtraParams.ReadFromParcel(parcel);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, Unmarshalling_001, TestSize.Level1)
{
    ...
    int32_t result1 = continuationExtraParams1.Marshalling(parcel);
    ContinuationExtraParams *continuationExtraParams2 = continuationExtraParams1.Unmarshalling(parcel);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, OnRemoteRequest_001, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, OnRemoteRequest_002, TestSize.Level1)
{
    MessageParcel data;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, OnRemoteRequest_003, TestSize.Level1)
{
    MessageParcel data;
    data.WriteInterfaceToken(IDeviceSelectionNotifier::GetDescriptor());
    std::vector<ContinuationResult> continuationResults;
    ...
    int32_t result1 = ContinuationResult::WriteContinuationResultsToParcel(data, continuationResults);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ContinuationManagerTest, OnRemoteRequest_004, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
