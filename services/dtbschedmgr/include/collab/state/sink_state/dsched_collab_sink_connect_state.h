...
#ifndef OHOS_DSCHED_COLLAB_SINK_CONNECT_STATE_H
#define OHOS_DSCHED_COLLAB_SINK_CONNECT_STATE_H
...
class CollabSinkConnectState : public DSchedCollabState {
public:
    explicit CollabSinkConnectState(std::shared_ptr<DSchedCollabStateMachine> stateMachine);
    ~CollabSinkConnectState();
...
private:
    using DSchedStateFunc = int32_t (CollabSinkConnectState::*)(std::shared_ptr<DSchedCollab> dCollab,
...
#endif  // OHOS_DSCHED_COLLAB_SINK_CONNECT_STATE_H