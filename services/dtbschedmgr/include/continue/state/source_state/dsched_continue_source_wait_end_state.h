...
#ifndef OHOS_DSCHED_CONTINUE_SOURCE_WAIT_END_STATE_H
#define OHOS_DSCHED_CONTINUE_SOURCE_WAIT_END_STATE_H
...
class DSchedContinueWaitEndState : public DSchedContinueState {
public:
    explicit DSchedContinueWaitEndState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
    ~DSchedContinueWaitEndState();
...
private:
    int32_t DoNotifyCompleteTask(std::shared_ptr<DSchedContinue> dContinue,
