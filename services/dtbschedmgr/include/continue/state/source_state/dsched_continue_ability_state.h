...
#ifndef OHOS_DSCHED_CONTINUE_ABILITY_STATE_H
#define OHOS_DSCHED_CONTINUE_ABILITY_STATE_H
...
class DSchedContinueAbilityState : public DSchedContinueState {
public:
    explicit DSchedContinueAbilityState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
    ~DSchedContinueAbilityState();
