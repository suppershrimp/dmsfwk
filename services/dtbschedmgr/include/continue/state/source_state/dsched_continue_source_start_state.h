...
#ifndef OHOS_DSCHED_CONTINUE_SOURCE_START_STATE_H
#define OHOS_DSCHED_CONTINUE_SOURCE_START_STATE_H
...
class DSchedContinueSourceStartState : public DSchedContinueState {
public:
    explicit DSchedContinueSourceStartState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
    ~DSchedContinueSourceStartState();
