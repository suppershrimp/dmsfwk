...
#ifndef OHOS_DSCHED_CONTINUE_SINK_START_STATE_H
#define OHOS_DSCHED_CONTINUE_SINK_START_STATE_H
...
class DSchedContinueSinkStartState : public DSchedContinueState {
public:
    explicit DSchedContinueSinkStartState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
    ~DSchedContinueSinkStartState();
