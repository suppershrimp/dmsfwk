...
#ifndef OHOS_DSCHED_CONTINUE_SINK_END_STATE_H
#define OHOS_DSCHED_CONTINUE_SINK_END_STATE_H
...
class DSchedContinueSinkEndState : public DSchedContinueState {
public:
    explicit DSchedContinueSinkEndState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
    ~DSchedContinueSinkEndState();
