...
#ifndef OHOS_DSCHED_CONTINUE_SINK_WAIT_END_STATE_H
#define OHOS_DSCHED_CONTINUE_SINK_WAIT_END_STATE_H
...
class DSchedContinueSinkWaitEndState : public DSchedContinueState {
public:
    explicit DSchedContinueSinkWaitEndState(std::shared_ptr<DSchedContinueStateMachine> stateMachine);
