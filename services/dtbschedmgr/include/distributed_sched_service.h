...
public:
    ...
    int32_t RegisterAbilityToken(const sptr<IRemoteObject>& token, const sptr<IRemoteObject>& appThread) override;
    int32_t UnregisterAbilityToken(const sptr<IRemoteObject>& token, const sptr<IRemoteObject>& appThread) override;
private:
