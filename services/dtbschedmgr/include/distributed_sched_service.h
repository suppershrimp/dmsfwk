...
public:
    ...
    int32_t NotifyFreeInstall(int64_t sessionId, int32_t resultCode);
    ...
    int32_t StartFreeInstallFromRemote(const FreeInstallInfo& info, int64_t sessionId) override;
    int32_t NotifyCompleteFreeInstallFromRemote(int64_t sessionId, int32_t resultCode)override;
    int32_t NotifyCompleteFreeInstall(const std::string& deviceId, int64_t sessionId, int32_t resultCode);
private:
