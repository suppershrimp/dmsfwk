...
public:
    ...
    DmsDeviceInfo(const std::string& deviceName, const std::string& deviceType, const std::string& deviceId,
        int32_t deviceState = ONLINE)
        : deviceName_(deviceName), deviceType_(GetEnumDeviceType(deviceType)),
        deviceId_(deviceId), deviceState_(deviceState) {}
...
private:
    int32_t GetEnumDeviceType(const std::string& deviceType);
