...
private:
    ...
    bool CheckBroadcastCondition(const MissionStatus& status, MissionEventType type);
...
private:
    ...
    public:
        ...
        void OnDeviceScreenOff();
        void OnDeviceScreenOn();
        void ResetScreenOffInfo();
        void SetScreenOffInfo(LastUnfoInfo info);
    ...
    void PostScreenOffEventAfterDelay(int32_t missionId, uint8_t type, int32_t timeout);
