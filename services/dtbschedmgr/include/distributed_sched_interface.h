...
public:
    ...
    virtual int32_t RegisterAbilityToken(const sptr<IRemoteObject>& token, const sptr<IRemoteObject>& appThread) = 0;
    virtual int32_t UnregisterAbilityToken(const sptr<IRemoteObject>& token, const sptr<IRemoteObject>& appThread) = 0;
    enum {
