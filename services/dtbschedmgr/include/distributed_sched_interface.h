...
public:
    ...
    virtual int32_t StartFreeInstallFromRemote(const FreeInstallInfo& info, int64_t sessionId) = 0;
    virtual int32_t NotifyCompleteFreeInstallFromRemote(int64_t sessionId, int32_t resultCode) = 0;
    enum {
        ...
        NOTIFY_COMPLETE_FREE_INSTALL_FROM_REMOTE = 202,
    };
};
} // namespace DistributedSchedule
} // namespace OHOS
