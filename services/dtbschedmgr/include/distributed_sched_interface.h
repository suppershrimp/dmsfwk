...
public:
    ...
    virtual int32_t StartFreeInstallFromRemote(const FreeInstallInfo &info, int64_t sessionId)
    {
        return 0;
    }
    virtual int32_t NotifyCompleteFreeInstallFromRemote(int64_t sessionId, int32_t resultCode)
    {
        return 0;
    }
    enum {
