...
public:
    ...
    bool PushCallback(int64_t sessionId, const sptr<IRemoteObject>& callback,
        const std::string& deviceId, bool isContinue);
    sptr<IRemoteObject> PopCallback(int64_t sessionId);
...
private:
    ...
    std::atomic<int64_t> currSessionId_ {0};
