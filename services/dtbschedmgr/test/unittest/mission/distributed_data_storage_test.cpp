 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, InsertTest_001, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, DeleteTest_002, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, FuzzyDeleteTest_002, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, QueryTest_002, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, QueryTest_003, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, QueryTest_004, TestSize.Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, QueryTest_005, TestSize.Level0)
{
...
/**
 * @tc.name: SyncTest_001
 * @tc.desc: test query DistributedDataStorage
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DistributedDataStorageTest, SyncTest_001, TestSize.Level0)
{
    DTEST_LOG << "DistributedDataStorageTest SyncTest_001 start" << std::endl;
    distributedDataStorage_->Init();
    this_thread::sleep_for(1s);
    std::string deviceId = GetLocalDeviceId();
    bool ret = distributedDataStorage_->Sync(deviceId);
    EXPECT_EQ(true, ret);
    distributedDataStorage_->Stop();
    DTEST_LOG << "DistributedDataStorageTest SyncTest_001 end" << std::endl;
}
} // namespace DistributedSchedule
} // namespace OHOS