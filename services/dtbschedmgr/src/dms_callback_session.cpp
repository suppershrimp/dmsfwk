...
bool DmsCallbackSession::PushCallback(int64_t sessionId, const sptr<IRemoteObject>& callback,
...
sptr<IRemoteObject> DmsCallbackSession::PopCallback(int64_t sessionId)
{
    std::lock_guard<std::mutex> autoLock(callbackMapMutex_);
