...
bool DmsCallbackSession::PushCallback(int32_t sessionId, const sptr<IRemoteObject>& callback, bool isContinue)
{
    if (sessionId <= 0) {
    ...
    CallbackSessionItem item {callback, sessionId, isContinue};
