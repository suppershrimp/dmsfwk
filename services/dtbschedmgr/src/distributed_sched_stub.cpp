...
void DistributedSchedStub::InitLocalFuncsMap()
{
    ...
    localFuncsMap_[UNREGISTER_DEVICE_SELECTION_CALLBACK] =
        &DistributedSchedStub::UnregisterDeviceSelectionCallbackInner;
...
void DistributedSchedStub::InitRemoteFuncsMap()
{
