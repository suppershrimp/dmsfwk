...
void DmsContinueConditionMgr::InitConditionFuncs()
{
    ...
    sysFuncMap_[SYS_EVENT_SCREEN] = &DmsContinueConditionMgr::OnScreenOffChanged;

    missionFuncMap_[MISSION_EVENT_FOCUSED] = &DmsContinueConditionMgr::OnMissionFocusedLocked;
    missionFuncMap_[MISSION_EVENT_UNFOCUSED] = &DmsContinueConditionMgr::OnMissionUnfocusedLocked;
    missionFuncMap_[MISSION_EVENT_DISTORYED] = &DmsContinueConditionMgr::OnMissionDestoryLocked;
    missionFuncMap_[MISSION_EVENT_ACTIVE] = &DmsContinueConditionMgr::OnMissionActiveLocked;
    missionFuncMap_[MISSION_EVENT_INACTIVE] = &DmsContinueConditionMgr::OnMissionInactiveLocked;
    ...
    conditionFuncMap_[MISSION_EVENT_DISTORYED] = &DmsContinueConditionMgr::CheckSendUnfocusedCondition;
...
void DmsContinueConditionMgr::InitMissionCondition()
{
    ...
    {
        std::lock_guard<std::mutex> missionlock(missionMutex_);
        InitMissionStatusLocked(currentAccountId);
    }
}
...
int32_t DmsContinueConditionMgr::OnScreenOffChanged(bool isScreenOff)
{
    HILOGI("isScreenOff changed, before: %{public}d, after: %{public}d", isScreenOff_.load(), isScreenOff);
    isScreenOff_.store(isScreenOff);
    return ERR_OK;
}
...
void DmsContinueConditionMgr::OnUserSwitched(int32_t accountId)
{
    ...
    std::lock_guard<std::mutex> missionlock(missionMutex_);
    InitMissionStatusLocked(accountId);
    return;
}
...
int32_t DmsContinueConditionMgr::UpdateMissionStatus(int32_t accountId, int32_t missionId, MissionEventType type)
{
    ...
    if (missionList == missionMap_.end()) {
        HILOGW("no mission status records for user %{public}d, start to init", accountId);
        InitMissionStatusLocked(accountId);
        return ERR_OK;
    }
...
void DmsContinueConditionMgr::InitMissionStatusLocked(int32_t accountId)
{
    HILOGI("InitMissionStatusLocked for user %{public}d start", accountId);
    ...
    HILOGI("InitMissionStatusLocked for user %{public}d end", accountId);
    return;
}
...
int32_t DmsContinueConditionMgr::OnMissionFocusedLocked(int32_t accountId, int32_t missionId)
{
...
int32_t DmsContinueConditionMgr::OnMissionUnfocusedLocked(int32_t accountId, int32_t missionId)
{
    HILOGI("accountId %{public}d, missionId %{public}d", accountId, missionId);
...
int32_t DmsContinueConditionMgr::OnMissionDestoryLocked(int32_t accountId, int32_t missionId)
{
    HILOGI("accountId %{public}d, missionId %{public}d", accountId, missionId);
...
int32_t DmsContinueConditionMgr::OnMissionActiveLocked(int32_t accountId, int32_t missionId)
{
    HILOGI("accountId %{public}d, missionId %{public}d", accountId, missionId);
...
int32_t DmsContinueConditionMgr::OnMissionInactiveLocked(int32_t accountId, int32_t missionId)
{
    HILOGI("accountId %{public}d, missionId %{public}d", accountId, missionId);
...
int32_t DmsContinueConditionMgr::OnUserSwitchedLocked(int32_t accountId, int32_t missionId)
{
    return ERR_OK;
}

int32_t DmsContinueConditionMgr::OnUserDestoryLocked(int32_t accountId, int32_t missionId)
{
    return ERR_OK;
}
