...
void DeviceSelectionNotifierProxy::OnDeviceConnect(const std::vector<AAFwk::ContinuationResult>& continuationResults)
{
    HILOGD("called");
    MessageParcel data;
    ...
    if (!AAFwk::ContinuationResult::WriteContinuationResultsToParcel(data, continuationResults)) {
        return;
    }
