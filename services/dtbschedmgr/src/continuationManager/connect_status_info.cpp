...
AAFwk::DeviceConnectStatus ConnectStatusInfo::GetDeviceConnectStatus() const
{
    return deviceConnectStatus_;
}

void ConnectStatusInfo::SetDeviceConnectStatus(const AAFwk::DeviceConnectStatus& deviceConnectStatus)
{
