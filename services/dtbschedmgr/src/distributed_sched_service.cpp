...
int32_t DistributedSchedService::RegisterAbilityToken(const sptr<IRemoteObject>& token,
    const sptr<IRemoteObject>& appThread)
{
    return 0;
}

int32_t DistributedSchedService::UnregisterAbilityToken(const sptr<IRemoteObject>& token,
    const sptr<IRemoteObject>& appThread)
{
    return 0;
}
