...
int32_t DistributedSchedProxy::RegisterAbilityToken(const sptr<IRemoteObject>& token,
    const sptr<IRemoteObject>& appThread)
{
    return 0;
}

int32_t DistributedSchedProxy::UnregisterAbilityToken(const sptr<IRemoteObject>& token,
    const sptr<IRemoteObject>& appThread)
{
    return 0;
}
