...
int32_t DistributedSchedProxy::StartFreeInstallFromRemote(const FreeInstallInfo& info, int64_t sessionId)
{
    ...
    PARCEL_WRITE_HELPER(data, Int64, sessionId);
    nlohmann::json extraInfoJson;
...
int32_t DistributedSchedProxy::NotifyCompleteFreeInstallFromRemote(int64_t sessionId, int32_t resultCode)
{
