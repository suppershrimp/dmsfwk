...
const std::string DMSDURATION_TOTALTIME = "Total Time Cost          : ";
...
constexpr int32_t DMSDURATION_TOTAL = 2;
constexpr int32_t DMSDURATION_SRCTODSTRPCTIME = 3;
constexpr int32_t DMSDURATION_SAVETIME = 4;
constexpr int32_t DMSDURATION_DSTTOSRCSAVETIME = 5;
...
void DmsContinueTime::Init()
{
    ...
    durationInfo_.push_back(DmsDuration(0, 0, DMSDURATION_TOTALTIME));
...
void DmsContinueTime::SetDeviceName()
{
...
std::string DmsContinueTime::WriteDurationInfo(DmsDuration duration)
{
    ...
    std::string message(cJSON_PrintUnformatted(durationInfo));
    if (message.empty()) {
...
void DmsContinueTime::DealDuration()
{
...
void DmsContinueTime::AppendInfo()
{
    SetDeviceName();
    DealDuration();
    appendInfo_.append("== SOURCE ==                            |== SINK ==");
    appendInfo_.append("\n");
    appendInfo_.append("NetWord Id:");
    appendInfo_.append(DnetworkAdapter::AnonymizeNetworkId(srcInfo_.netWorkId.c_str()));
    appendInfo_.append("                 |NetWord Id::");
    appendInfo_.append(DnetworkAdapter::AnonymizeNetworkId(dstInfo_.netWorkId.c_str()));
    appendInfo_.append("\n");
    appendInfo_.append("Device Name:");
    appendInfo_.append(srcInfo_.deviceName);
    appendInfo_.append("          |Device Name:");
    appendInfo_.append(dstInfo_.deviceName);
    appendInfo_.append("\n");
    appendInfo_.append("Bundle Name:");
    appendInfo_.append(srcInfo_.bundleName);
    appendInfo_.append("     |Bundle Name:");
    appendInfo_.append(dstInfo_.bundleName);
    appendInfo_.append("\n");
    appendInfo_.append("Ability Name:");
    appendInfo_.append(srcInfo_.abilityName);
    appendInfo_.append("                |Ability Name:");
    appendInfo_.append(dstInfo_.abilityName);
    appendInfo_.append("\n");
    appendInfo_.append("------------------------------------------------------------------------------------\n");
