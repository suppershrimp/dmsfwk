...
namespace DistributedCollab {
    ...
    int32_t AVSenderEngine::InitVideoHeaderFilter()
    {
        ...
        if (!videoEncoderFilter_) {
            ...
            // videoEncoderFilter_ = Media::Pipeline::FilterFactory::Instance().CreateFilter<Media::Pipeline::SurfaceEncoderFilter>("builtin.recorder.videoencoder", FilterType::FILTERTYPE_VENC);
        }
        if (videoEncoderFilter_) {
    ...
    void AVSenderEngine::SetVideoSource(const VideoSourceType source)
    {
        ...
        case VideoSourceType::YUV420P:
            videoEncFormat_->Set<Media::Tag::VIDEO_PIXEL_FORMAT>(Media::Plugins::VideoPixelFormat::YUV420P);
            HILOGI("AVSenderEngine SetVideoSource YUV420P");
            break;
        case VideoSourceType::YUVI420:
            videoEncFormat_->Set<Media::Tag::VIDEO_PIXEL_FORMAT>(Media::Plugins::VideoPixelFormat::YUVI420);
            HILOGI("AVSenderEngine SetVideoSource YUVI420");
            break;
        ...
        case VideoSourceType::SURFACE_FORMAT:
            videoEncFormat_->Set<Media::Tag::VIDEO_PIXEL_FORMAT>(Media::Plugins::VideoPixelFormat::SURFACE_FORMAT);
            HILOGI("AVSenderEngine SetVideoSource SURFACE_FORMAT");
            break;
        case VideoSourceType::RGBA:
            videoEncFormat_->Set<Media::Tag::VIDEO_PIXEL_FORMAT>(Media::Plugins::VideoPixelFormat::RGBA);
            HILOGI("AVSenderEngine SetVideoSource RGBA");
            break;
        default:
            videoEncFormat_->Set<Media::Tag::VIDEO_PIXEL_FORMAT>(Media::Plugins::VideoPixelFormat::SURFACE_FORMAT);
