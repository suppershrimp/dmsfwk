...
namespace DistributedCollab {
    ...
    static Media::Pipeline::AutoRegisterFilter<SurfaceDecoderFilter> g_registerSurfaceDecoderFilter("builtin.dtbcollab.surfacedecoder",
    ...
    Status SurfaceDecoderFilter::LinkNext(const std::shared_ptr<Filter>& nextFilter, StreamType outType)
    {
        ...
        std::shared_ptr<FilterLinkCallback> filterLinkCallback = std::make_shared<SurfaceDecoderFilterLinkCallback>(shared_from_this());
        ...
        const std::shared_ptr<FilterLinkCallback>& callback)
    {
        ...
        if (ret == Status::OK) {
            std::shared_ptr<DecoderAdapterCallback> decoderSurfaceCallback = std::make_shared<SurfaceDecoderAdapterCallback>(shared_from_this());
