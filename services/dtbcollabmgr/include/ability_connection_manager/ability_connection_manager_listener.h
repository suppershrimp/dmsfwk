...
#ifndef OHOS_DISTRIBUTED_ABILITY_CONNECTION_MANAGER_LISTENER_H
#define OHOS_DISTRIBUTED_ABILITY_CONNECTION_MANAGER_LISTENER_H
 
#include "ability_connection_manager_stub.h"

namespace OHOS {
namespace DistributedCollab {
class AbilityConnectionManagerListener : public AbilityConnectionManagerStub {
...
#endif //OHOS_DISTRIBUTED_ABILITY_CONNECTION_MANAGER_LISTENER_H