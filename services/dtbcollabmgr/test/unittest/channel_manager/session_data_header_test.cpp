...
namespace DistributedCollab {
    ...
    HWTEST_F(SessionDataHeaderTest, SerializeAndDeserialize_001, TestSize.Level1)
    {
        ...
        auto deserializedHeader = SessionDataHeader::Deserialize(serializedBuffer->Data(), serializedBuffer->Size());
    ...
    HWTEST_F(SessionDataHeaderTest, Deserialize_InsufficientReservedBytes, TestSize.Level1)
    {
        ...
        buffer[2] = 0;
        buffer[3] = SessionDataHeader::HEADER_LEN + 10; // exceed max size
    ...
    HWTEST_F(SessionDataHeaderTest, Deserialize_InvalidPayloadLength, TestSize.Level1)
    {
        ...
        auto result = SessionDataHeader::Deserialize(serializedBuffer->Data(), serializedBuffer->Size());
        ASSERT_FALSE(result.has_value());
    }
