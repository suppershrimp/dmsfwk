...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, InitTest_001, TestSize.Level3)
{
    ...
    /**
     * @tc.steps: step1. test Init when initHandler_ is not nullptr;
     */
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, InitNetworkIdManagerTest_001, TestSize.Level3)
{
    ...
    std::shared_ptr<DnetworkAdapter> dnetworkAdapter = nullptr;
...
/**
 * @tc.name: RegisterUuidNetworkIdMapTest_001
 * @tc.desc: test RegisterUuidNetworkIdMap
 * @tc.type: FUNC
 */
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, RegisterUuidNetworkIdMapTest_001, TestSize.Level3)
{
    DTEST_LOG << "DtbschedmgrDeviceInfoStorageTest RegisterUuidNetworkIdMapTest_001 start" << std::endl;
    /**
     * @tc.steps: step1. test RegisterUuidNetworkIdMap;
     */
    string networkId = "";
    DtbschedmgrDeviceInfoStorage::GetInstance().RegisterUuidNetworkIdMap(networkId);
    {
        ...
        auto iter = DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdMap_.find("");
        EXPECT_NE(iter, DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdMap_.end());
        if (iter != DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdMap_.end()) {
            EXPECT_EQ(iter->second, networkId);
        }
    }
    DTEST_LOG << "DtbschedmgrDeviceInfoStorageTest RegisterUuidNetworkIdMapTest_001 end" << std::endl;
}

/**
 * @tc.name: UnregisterUuidNetworkIdMapTest_001
 * @tc.desc: test UnregisterUuidNetworkIdMap
 * @tc.type: FUNC
 */
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, UnregisterUuidNetworkIdMapTest_001, TestSize.Level3)
{
    DTEST_LOG << "DtbschedmgrDeviceInfoStorageTest UnregisterUuidNetworkIdMapTest_001 start" << std::endl;
    /**
     * @tc.steps: step1. test UnregisterUuidNetworkIdMap;
     */
    string networkId = "";
    DtbschedmgrDeviceInfoStorage::GetInstance().UnregisterUuidNetworkIdMap(networkId);
    {
        std::lock_guard<std::mutex> autoLock(DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdLock_);
        auto iter = DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdMap_.find("");
        EXPECT_EQ(iter, DtbschedmgrDeviceInfoStorage::GetInstance().uuidNetworkIdMap_.end());
    }
    DTEST_LOG << "DtbschedmgrDeviceInfoStorageTest UnregisterUuidNetworkIdMapTest_001 end" << std::endl;
}
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, GetDeviceIdSetTest_001, TestSize.Level3)
{
    ...
    EXPECT_NE(false, deviceIdSet.empty());
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, GetLocalDeviceFromDnetTest_001, TestSize.Level3)
{
    ...
    DtbschedmgrDeviceInfoStorage::GetInstance().DeviceOnlineNotify(devInfo);
    /**
     * @tc.steps: step6. test OnDeviceInfoChanged;
     */
    deviceId = "invalid deviceId for GetLocalDeviceFromDnet";
    DtbschedmgrDeviceInfoStorage::GetInstance().OnDeviceInfoChanged(deviceId);
    /**
     * @tc.steps: step7. test OnRemoteDied;
     */
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, ClearAllDevicesTest_001, TestSize.Level3)
{
    ...
    DtbschedmgrDeviceInfoStorage::GetInstance().ClearAllDevices();
    {
        ...
        EXPECT_EQ(true, DtbschedmgrDeviceInfoStorage::GetInstance().remoteDevices_.empty());
    }
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, GetDeviceInfoByIdTest_001, TestSize.Level3)
{
     ...
     */
    string deviceId = "invalid deviceId for GetDeviceInfoById";
    {
        lock_guard<mutex> autoLock(DtbschedmgrDeviceInfoStorage::GetInstance().deviceLock_);
...
HWTEST_F(DtbschedmgrDeviceInfoStorageTest, GetUuidByNetworkIdTest_001, TestSize.Level3)
{
    ...
    /**
     * @tc.steps: step1. test GetUuidByNetworkId when networkId is in map;
     */
    string networkId = "invalid networkId for GetUuidByNetworkId";
    string uuid = "invalid uuid for GetUuidByNetworkId";
    {
    ...
    string result = DtbschedmgrDeviceInfoStorage::GetInstance().GetUuidByNetworkId(networkId);
